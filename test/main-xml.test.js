...
describe("main-xml", () => {
  ...
  it("HEAD service", async () => {
    let response = await util.callHead(request, "/odata/v2/main?$format=atom");
  ...
  it("GET request", async () => {
    ...
    response = await util.callRead(request, "/odata/v2/main/Header(guid'e0582b6a-6d93-46d9-bd28-98723a285d40')/name", {
      accept: "application/xml",
    });
    expect(response.text).toBeDefined();
    response.text = cleanResponse(response.text);
  ...
  it("PUT request", async () => {
    ...
    response = await util.callWrite(
      request,
      "/odata/v2/main/Header(guid'b853cdb8-5531-4141-b319-d405ae5d1e63')",
      payload,
      true,
      {
        accept: "application/xml",
  ...
  it("DELETE request", async () => {
    ...
    response = await util.callDelete(request, "/odata/v2/main/Header(guid'c853cdb8-5531-4141-b319-d405ae5d1e63')", {
      accept: "application/xml",
      "content-type": "application/atom+xml",
    });
  ...
  it("GET function", async () => {
    ...
    response = await util.callRead(request, "/odata/v2/main/unboundMassFunction?ids=TEST1", {
      accept: "application/xml",
    });
    expect(response.headers["content-type"]).toEqual("application/atom+xml;charset=utf-8");
    response.text = cleanResponse(response.text);
    ...
    response = await util.callRead(request, "/odata/v2/main/unboundFunctionPrimitive?num=1", {
      accept: "application/xml",
    });
    expect(response.headers["content-type"]).toEqual("application/atom+xml;charset=utf-8");
    response.text = cleanResponse(response.text);
    ...
    response = await util.callRead(request, "/odata/v2/main/unboundFunctionEntity?num=1&text=test", {
      accept: "application/xml",
    });
    expect(response.headers["content-type"]).toEqual("application/atom+xml;charset=utf-8");
    response.text = cleanResponse(response.text);
  ...
  it("POST action", async () => {
    let response = await util.callWrite(request, "/odata/v2/main/unboundAction?num=1&text=abc", {}, false, {
      accept: "application/xml",
    });
    expect(response.headers["content-type"]).toEqual("application/atom+xml;charset=utf-8");
    response.text = cleanResponse(response.text);
    ...
    response = await util.callWrite(request, "/odata/v2/main/unboundMassAction?ids=TEST1", {}, false, {
      accept: "application/xml",
    });
    expect(response.headers["content-type"]).toEqual("application/atom+xml;charset=utf-8");
    response.text = cleanResponse(response.text);
    ...
    response = await util.callWrite(request, "/odata/v2/main/unboundActionPrimitive?num=1", {}, false, {
      accept: "application/xml",
    });
    expect(response.headers["content-type"]).toEqual("application/atom+xml;charset=utf-8");
    response.text = cleanResponse(response.text);
    ...
    response = await util.callWrite(request, "/odata/v2/main/unboundActionEntity?num=1&text=test", {}, false, {
      accept: "application/xml",
    });
    expect(response.headers["content-type"]).toEqual("application/atom+xml;charset=utf-8");
    response.text = cleanResponse(response.text);
  ...
  it("GET error response", async () => {
    ...
    response = await util.callRead(request, "/odata/v2/main/Header(guid'a0582b6a-6d93-46d9-bd28-98723a285d40')", {
      accept: "application/xml",
    });
    expect(response.text).toBeDefined();
    response.text = cleanResponse(response.text);
    ...
    response = await util.callRead(request, "/odata/v2/main/unboundErrorFunction", {
      accept: "application/xml",
    });
    expect(response.text).toBeDefined();
    response.text = cleanResponse(response.text);
  ...
  it("GET batch request", async () => {
    ...
    expect(first.headers["content-type"]).toEqual(expect.stringContaining("application/json"));
